    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthResponseDto> RegisterAsync(RegisterRequestDto registerRequest)
        {
            try
            {
                ...
                // 4. Bắt đầu transaction sau khi validate xong, rồi lưu User để lấy UserId
            ...
            catch (Exception ex)
            {
                ...
                // Thử xóa file nếu đã upload nhưng transaction fail
                try
                {
                    // Chỉ có thể xóa nếu đã có đường dẫn ảnh tạm thời trong scope
                    // Không có biến cục bộ ở đây, nên không thực hiện được.
                }
                catch { }
                return new AuthResponseDto
                {
