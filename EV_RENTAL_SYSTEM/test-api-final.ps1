...
try {
    $createResponse = Invoke-RestMethod -Uri "https://localhost:7181/api/rental" -Method POST -Body $createRentalBody -ContentType "application/json" -Headers @{"Authorization" = "Bearer YOUR_TOKEN_HERE"}
