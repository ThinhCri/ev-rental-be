...
namespace EV_RENTAL_SYSTEM.Migrations
{
    ...
    [Migration("20251026115400_AddRentalWorkflowFeatures")]
    partial class AddRentalWorkflowFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EV_RENTAL_SYSTEM.Models.Order", b =>
                {
                    ...
                    b.Property<string>("VerificationLicenseImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("Verification_License_ImageUrl");
            ...
            modelBuilder.Entity("EV_RENTAL_SYSTEM.Models.VehicleConditionHistory", b =>
                {
                    b.Property<int>("VehicleConditionHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("VehicleConditionHistory_Id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VehicleConditionHistoryId"));
                    ...
                    b.Property<string>("AdditionalChargesReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("Additional_Charges_Reason");
                    ...
                    b.Property<string>("VehicleImagesUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("Vehicle_Images_Url");

                    b.HasKey("VehicleConditionHistoryId");

                    b.HasIndex("LicensePlateId");

                    b.HasIndex("OrderId");

                    b.ToTable("VehicleConditionHistory");
                });
            ...
            modelBuilder.Entity("EV_RENTAL_SYSTEM.Models.VehicleConditionHistory", b =>
                {
                    ...
                    b.HasOne("EV_RENTAL_SYSTEM.Models.Order", "Order")
                        .WithMany("VehicleConditionHistories")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EV_RENTAL_SYSTEM.Models.Order", b =>
                {
                    ...
                    b.Navigation("VehicleConditionHistories");
                });
